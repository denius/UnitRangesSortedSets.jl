    ...
    for Ti in (Int, UInt, UInt16, Float64)
        for TypeURSS in (UnitRangesSortedVector, UnitRangesSortedSet)
            @eval begin
                ...
                @test test_iseqial(push!(rs, 8),  (3:4, 8))
                @test test_iseqial(push!(rs, 2),  (2:4, 8))
                ...
                @test test_iseqial(push!(rs, 6),  (1:4, 6:6, 8:10))
                @test test_iseqial(push!(rs, 6),  (1:4, 6:6, 8:10))
                ...
                @test test_iseqial(push!(rs, 9:12),  (9:14, 23:24))
                @test test_iseqial(push!(rs, 16:17),  (9:14, 16:17, 23:24))
                @test test_iseqial(push!(rs, 25:26),  (9:14, 16:17, 23:26))
                @test test_iseqial(push!(rs, 24:26),  (9:14, 16:17, 23:26))
                @test test_iseqial(push!(rs, 28:29),  (9:14, 16:17, 23:26, 28:29))
                @test test_iseqial(push!(rs, 28:29),  (9:14, 16:17, 23:26, 28:29))
                @test test_iseqial(push!(rs, 16:15),  (9:14, 16:17, 23:26, 28:29))
            end
        end
    end
end
